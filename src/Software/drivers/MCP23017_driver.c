...
/* ==================== Board-Specific Accessors ==================== */
/* PDNode: devices are registered on demand by USBATask via mcp_register(). */
/* MCP2017_Init() is a no-op here — individual tasks own their MCP devices.  */

void MCP2017_Init(void) { /* no-op for PDNode — see USBATask for device init */ }
